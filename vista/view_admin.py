...
# En este fichero se desarrolla la interfaz para el menú de administrador, donde se podrán crear nuevas cuentas, modificar contraseñas, asignar
...
class InterfazAdmin:
    ...
    def widgets(self):
        ...
        imagen_crearusuario_tk = ImageTk.PhotoImage(imagen_crearusuario_resize)
        self.boton_crearusuario.config(image=imagen_crearusuario_tk,compound='left',anchor='center')
        ...
        imagen_eliminarusuario_resize = imagen_eliminarusuario_pil.resize((30,30))
        imagen_eliminarusuario_tk = ImageTk.PhotoImage(imagen_eliminarusuario_resize)
        self.boton_eliminarusuario.config(image=imagen_eliminarusuario_tk,compound='left',anchor='center')
        ...
        self.boton_eliminarbd.config(image=imagen_eliminarbd_tk,compound='left',anchor='center')
        self.boton_eliminarbd.place(relx=0.5,rely=0.35,anchor='center')
        self.boton_eliminarbd.image = imagen_eliminarbd_tk

# Clase para creación de la interfaz de nuevo usuario
class InterfazNuevoUsuario:
    ...
    def widgets(self):
        ...
        self.frame_nuevacuenta.config(width=400,height=220,background='#EDE2E0')
        self.frame_nuevacuenta.place(x=0,y=0)

        # Labels
        self.labelcuenta = Label(self.frame_nuevacuenta,text='Cuenta',font=('century gothic',14),background='#EDE2E0')
        self.labelcuenta.place(x=15,y=20)

        self.labelcontraseña = Label(self.frame_nuevacuenta,text='Contraseña',font=('century gothic',14),background='#EDE2E0')
        self.labelcontraseña.place(x=15,y=70)

        self.labelrol = Label(self.frame_nuevacuenta,text='Rol',font=('century gothic',14),background='#EDE2E0')
        self.labelrol.place(x=15,y=120)

        #Entries
        self.entrycuenta = Entry(self.frame_nuevacuenta,font=('century gothic',14),width=19)
        self.entrycuenta.place(x=150,y=20)

        self.entrycontraseña = Entry(self.frame_nuevacuenta,font=('century gothic',14),width=19)
        self.entrycontraseña.place(x=150,y=70)

        self.entryrol = ttk.Combobox(self.frame_nuevacuenta,width=18,font=('century gothic',14))
        ...
        self.boton_crearusuario.config(text='Crear',font=('century gothic',14,'bold'),width=10,background='#D3B9B4',bd=2,relief='groove')
...
class InterfazEliminar:
    ...
    def widgets(self):
        ...
        self.frame_modificacion.config(width=350,height=220,background='#EDE2E0')
        self.frame_modificacion.place(x=0,y=0)

        # Labels
        self.labelcuenta = Label(self.frame_modificacion,text='Cuenta',font=('century gothic',14),background='#EDE2E0')
        self.labelcuenta.place(x=15,y=20)

        #Entries
        self.entrycuenta = ttk.Combobox(self.frame_modificacion,width=18,font=('century gothic',14))
        self.entrycuenta.place(x=110,y=20)

        # Boton
        self.boton_modificarcontraseña = Button(self.frame_modificacion)
        self.boton_modificarcontraseña.config(text='Eliminar',font=('century gothic',14,'bold'),width=10,background='#D3B9B4',bd=2,relief='groove')
        self.boton_modificarcontraseña.place(relx=0.5,rely=0.4,anchor='center')
