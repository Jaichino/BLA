...
class MenuPrincipal:
    ...
    def rutas(self, *paths):
        ...
        ''' Metodo para el manejo de las rutas de imagenes a la hora de
    ...
    def widgets(self):
        ...
        self.boton_ventas.config(
            image=imagen_venta_tk, compound='top', pady=10
        )
        ...
        imagen_cuentacorriente_resize = (
            imagen_cuentacorriente_pil.resize((50, 50))
        )
        imagen_cuentacorriente_tk = ImageTk.PhotoImage(
            imagen_cuentacorriente_resize
        )
        self.boton_cuentacorriente.config(
            image=imagen_cuentacorriente_tk, compound='top', pady=10
        )
        ...
        self.boton_inventario.config(
            image=imagen_inventario_tk, compound='top', pady=10
        )
        ...
        self.boton_reportes.config(
            image=imagen_reportes_tk, compound='top', pady=10
        )
        ...
        imagen_administrador_resize = (
            imagen_administrador_pil.resize((40, 40))
        )
        imagen_administrador_tk = ImageTk.PhotoImage(
            imagen_administrador_resize
        )
        self.boton_administrador.config(
            image=imagen_administrador_tk, compound='top', pady=10
        )
